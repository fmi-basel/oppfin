...
public interface PresetRepository extends
    ...
    public List<PresetEntity> findAllBySearchboxAndVisible(SearchboxEntity searchbox, Boolean visible);

    public List<PresetEntity> findAllBySearchboxAndVisibleOrderByPositionAsc(SearchboxEntity searchbox, Boolean visible);
