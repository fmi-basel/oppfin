...
import org.datacontract.schemas._2004._07.EEN_Merlin_Backend_Core_BO_PODService.ObjectFactory;
import eu.europa.ec.een.IPODServiceSOAPProxy;
...
public class EENCollection extends AbstractBatchCollection implements
    ...
    public Date getPublishedValue(FieldMap fields) {
        LOGGER.debug("getPublishedValue"+(Date) (fields.get("eenDatumSubmit").size() != 0
    ...
    public Date getDeadlineValue(FieldMap fields) {
        LOGGER.debug(fields +"===>getDeadlineValue"+(Date) (fields.get("eenDatumDeadline").size() != 0
        ...
        return new ItemReader<Profile>() {
            ...
            public void fillProfiles(Date from, Date to) {
                try {
                    ...
                    JAXBElement<String> jaxbDeadlineDateAfter
                            = new JAXBElement(new QName("http://schemas.datacontract.org/2004/07/EEN.Merlin.Backend.Core.BO.PODService", "DeadlineDateAfter"), String.class, dfmt.format(from));
                    JAXBElement<String> jaxbDeadlineDateBefore
                            = new JAXBElement(new QName("http://schemas.datacontract.org/2004/07/EEN.Merlin.Backend.Core.BO.PODService", "DeadlineDateBefore"), String.class, dfmt.format(to));
