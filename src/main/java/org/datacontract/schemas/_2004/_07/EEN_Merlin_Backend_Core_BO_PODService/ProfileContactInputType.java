...
/**
 * <p>Java class for profileContactInput complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="profileContactInput"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "profileContactInput", propOrder = {
    "partnerid",
    "responsible"
})
public class ProfileContactInputType {

    @XmlElement(required = true, nillable = true)
    protected String partnerid;
    @XmlElementRef(name = "responsible", namespace = "http://schemas.datacontract.org/2004/07/EEN.Merlin.Backend.Core.BO.PODService", type = JAXBElement.class, required = false)
